...
let results = null;
let pdfWindow = null;
let amountTypeDropDown = null;
let amountTypeSelected = 'solicitado';
const amountTypeOptions = ["solicitado", "otorgado en primera instancia"];
...
function showResults(documents, opts) {
    ...
    if (documents != null) {
        ...
        //Caratulado
        var caratulado = results.append('tr')
            .style('max-width', '100%')
            // .style('border-top', '1px solid grey')
            .style('border-bottom', '1px solid grey')
            .style('text-align', 'justify');

        caratulado.append('td')
            .append('i')
            .attr('class', 'fas fa-book-open fa-lg')
            .style('color', 'blue');
        ...
        //Hechos fundantes
        var hechosFundantes = results.append('tr')
            .style('max-width', '100%')
            .style('border-top', '1px solid grey')
            .style('border-bottom', '1px solid grey')
            .style('text-align', 'justify')
        ...
        hechosFundantes.append('td')
            .append('i')
            .attr('class', 'far fa-eye fa-lg')
            .style('color', 'blue');

        hechosFundantes.append('td')
            .style('padding', '1%')
            .style('white-space', 'pre-wrap')
            .text("Hechos fundantes")



        //Año sentencia
        var fechaSentencia = results.append('tr')
            .style('max-width', '100%')
            .style('border-top', '1px solid grey')
            .style('border-bottom', '1px solid grey')
            .style('text-align', 'justify');

        fechaSentencia.append('td')
            .append('i')
            .attr('class', 'far fa-calendar-alt fa-lg')
            .style('color', 'blue');
        ...
        //Edad víctima
        //Sexo víctima
        var datosVictima = results.append('tr')
            .style('max-width', '100%')
            .style('border-top', '1px solid grey')
            .style('border-bottom', '1px solid grey')
            .style('text-align', 'justify');

        datosVictima.append('td')
            .append('i')
            .attr('class', 'fas fa-user-alt fa-lg')
            .style('color', 'blue');
        ...
        datosVictima.append('td')
            ...
            .style('white-space', 'pre-wrap')
            .text((d) => {
                return `Edad: ${_.get(d, opts.resultsEdadVictimaField)}   Sexo: ${_.get(d, opts.resultsSexoVictimaField)}`
            })



        //Nombre juzgado primera instancia
        var juzgadoPrimeraInstancia = results.append('tr')
            .style('max-width', '100%')
            .style('border-top', '1px solid grey')
            .style('border-bottom', '1px solid grey')
            .style('text-align', 'justify');

        juzgadoPrimeraInstancia.append('td')
            .append('i')
            .attr('class', 'fa fa-university fa-lg')
            .style('color', 'blue');
        ...
        if (!_.isEqual(opts.unit, 'uf')) {
            ...
            var montoPasado = results.append('tr')
                .style('max-width', '100%')
                .style('border-top', '1px solid grey')
                .style('border-bottom', '1px solid grey')
                .style('text-align', 'justify');

            montoPasado.append('td')
                .append('i')
                .attr('class', 'far fa-money-bill-alt fa-lg')
                .style('color', 'blue');
            ...
            montoPasado.append('td')
                ...
                .style('white-space', 'pre-wrap')
                .text((d) => {
                    return `Monto ${opts.fillWith.includes('solicitado') ? "solicitado" : "otorgado 1ra instancia"}  (valor año ${new Date(_.get(d, opts.resultsFirstSentenceDateField)).getFullYear()} en pesos ): $${opts.fillWith.includes('solicitado') ?
                        numberWithPoints(_.get(d, opts.amountAskedFullField)) :
                        numberWithPoints(_.get(d, opts.amountGivenFirstField))
                        }`
                })

            var montoPresente = results.append('tr')
                .style('max-width', '100%')
                .style('border-top', '1px solid grey')
                .style('border-bottom', '1px solid grey')
                .style('text-align', 'justify');

            montoPresente.append('td')
                .append('i')
                .attr('class', 'far fa-money-bill-alt fa-lg')
                .style('color', 'blue');
            ...
            montoPresente.append('td')
                ...
                .style('white-space', 'pre-wrap')
                .text((d) => {
                    return `Monto ${opts.fillWith.includes('solicitado') ? "solicitado" : "otorgado 1ra instancia"}  (valor año  ${new Date().getFullYear()} en pesos ): $${opts.fillWith.includes('solicitado') ?
        ...
        if (_.isEqual(opts.unit, 'uf')) {
            ...
            montoPasado.append('td')
                ...
                .style('white-space', 'pre-wrap')
                .text((d) => {
                    return `Monto ${opts.fillWith.includes('solicitado') ? "solicitado" : "otorgado 1ra instancia"}  (valor año ${new Date(_.get(d, opts.resultsFirstSentenceDateField)).getFullYear()} en UF): ${opts.fillWith.includes('solicitado') ?
            ...
            montoPresente.append('td')
                ...
                .style('white-space', 'pre-wrap')
                .text((d) => {
                    return `Monto ${opts.fillWith.includes('solicitado') ? "solicitado" : "otorgado 1ra instancia"}  (valor año ${new Date().getFullYear()} en UF): ${opts.fillWith.includes('solicitado') ?
        ...
        var documentoSentencia = results.append('tr')
            .style('max-width', '100%')
            .style('border-top', '1px solid grey')
            // .style('border-bottom', '1px solid grey')
            .style('text-align', 'justify');

        documentoSentencia.append('td')
            .append('i')
            .attr('class', 'fas fa-file fa-lg')
            .style('color', 'blue')
            .on('click', (d) => {
        ...
        documentoSentencia.append('td')
            .style('padding', '1%')
            .style('white-space', 'pre-wrap')
            .text('Click en el ícono para ver sentencia')
...
function showTooltip(d, opts) {
    ...
    if (_.get(d, 'resume.total') > 0) {
        tooltip
            .append('p')
            .text(`Monto mínimo  ${opts.fillWith.includes('solicitado') ? "solicitado" : "otorgado 1ra instancia"}  (valor presente ${new Date().getFullYear()}):  
                ${_.isEqual(opts.unit, 'uf') ?
                    _.get(d, `resume.${opts.fillWith.includes('solicitado') ? 'solicitado' : 'primera'}.min`) + " UF" :
                    "$" + numberWithPoints(_.get(d, `resume.${opts.fillWith.includes('solicitado') ? 'solicitado' : 'primera'}.min`))
                }`)

        tooltip
            .append('p')
            .text(`Monto máximo  ${opts.fillWith.includes('solicitado') ? "solicitado" : "otorgado 1ra instancia"}  (valor presente ${new Date().getFullYear()}):  
                ${_.isEqual(opts.unit, 'uf') ?
                    _.get(d, `resume.${opts.fillWith.includes('solicitado') ? 'solicitado' : 'primera'}.max`) + " UF" :
                    "$" +  numberWithPoints(_.get(d, `resume.${opts.fillWith.includes('solicitado') ? 'solicitado' : 'primera'}.max`))
                }`)

        tooltip
            .append('p')
            .text(`Monto promedio  ${opts.fillWith.includes('solicitado') ? "solicitado" : "otorgado 1ra instancia"}  (valor presente ${new Date().getFullYear()}):  
                    ${_.isEqual(opts.unit, 'uf') ?
                    _.get(d, `resume.${opts.fillWith.includes('solicitado') ? 'solicitado' : 'primera'}.average`) + " UF" :
                    "$" + numberWithPoints(_.get(d, `resume.${opts.fillWith.includes('solicitado') ? 'solicitado' : 'primera'}.average`))
                }`)
    }

    tooltip.append('p')
        .text(`Causas relacionada: ${_.get(d, 'resume.total') > 0 ? _.get(d, 'resume.total') : 0}`)
    ...
    mapData.map(a => {
        ...
        if (a.data.length > 0) {
            ...
            _.assign(a, {
                data: filter,
                resume: {
                    total: amountsFirst.length,
                    primera: {
                        min: parseInt(minFirst).toString(),
                        max: parseInt(maxFirst).toString(),
                        average: parseInt(averageOtorgadoPrimera).toString()
                    },
                    solicitado: {
                        min: parseInt(minFull).toString(),
                        max: parseInt(maxFull).toString(),
                        average: parseInt(averageDemandado).toString()
                    }
                }
            });
        }
...
function clearDataFromAreas(data) {
    data.forEach(element => {
        if (element.data != undefined && element.data.length > 0) {
            element.data = [];
            element.resume = undefined
        }
    });
    return data;
}
...
function generateAreaStyle(data, colorScale, prefix, opts) {
    ...
    data.forEach(d => {
        if (d.data.length > 0) {
            ...
            var color = rgb(0, 0, 0);
            color = colorScale(_.get(d, `resume.${opts.fillWith}.${opts.statistic}`));
...
function chart(querySelector, data, opts) {
    ...
    finalOptions.bodyMapData.forEach(url => {
    ...
    mainContainer = d3.select(querySelector)
        ...
        .attr("height", height)
        .style("display", "flex")
        .style('background-color', _.get(finalOptions, 'mainBackgroundColor'))
    ...
    var divCategories = filtersContainer.append('div').append('p').attr('id', 'categoryAccidenteCount').text(`Accidente del Trabajo: ${accidenteCount}`);
    divCategories.append('p').attr('id', 'categoryEnfermedadCount').text(`Enfermedad Profesional: ${documents.length - accidenteCount}`);

    
    var divMontos = filtersContainer.append('div')
        // .text('Elegir tipo de montos:');

    divMontos.append('p').text('Elegir monto: ')

    amountTypeDropDown = divMontos
        .append('select')
        .attr('id', 'amountTypeSelect')
        .on('change', onchange);

    amountTypeDropDown
        .selectAll('option')
        .data(amountTypeOptions).enter()
        .append('option')
        .text((d) => { return d });
    ...
    function onchange() {
        categorySelected = d3.select('#categorySelect').property('value')
        amountTypeSelected = d3.select('#amountTypeSelect').property('value')
    ...
    function render(data, filters) {
        removeAll();
        if (filters.amountType.includes('solicitado')) {
            finalOptions.fillWith = "solicitado";
        } else {
            finalOptions.fillWith = "primera";
        }
        ...
        legendsContainer.append('div')
            ...
            .style('width', '100%')
            .text('Todos los montos agrupados están calculados a valor presente con respecto al año en que fueron dictadas las sentencias. ');
        ...
        function ready(values) {
            ...
            let amounts = filteredData.map(d => {
                if (_.isEqual(finalOptions.unit, 'uf')) {
                    return finalOptions.fillWith.includes('solicitado') ?
            ...
            let colorScale = d3.scaleSequential()
                ...
                .interpolator(d3.interpolateRgb(finalOptions.colorInit, finalOptions.colorFinal));



            var separatedData = separateSegmentedUnsegmented(filteredData, finalOptions);

            front.areas = clearDataFromAreas(front.areas);
            back.areas = clearDataFromAreas(back.areas);
            unsegmented.areas = clearDataFromAreas(unsegmented.areas);
            ...
            legendsContainer.append('p')
                ...
                .text(_.get(finalOptions, 'unit') === 'uf' ? 'Unidad de Fomento [uf]' : 'Pesos  [$]');
